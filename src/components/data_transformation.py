...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info('Categorical columns labeled')
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info('Loaded training nd testing data')
            logging.info('Obtaining model object')
            ...
            logging.info('Applying model object on training and testing dataset')

            input_feature_train_arr = model_obj.fit_transform(input_features_train_df)
            input_feature_test_arr = model_obj.transform(input_features_test_df)
            ...
            save_object(file_path = self.data_transformation_config.preprocessor_file_path, obj = model_obj)
